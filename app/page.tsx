...
function Card() {
  return (
    <div className='rounded-md shadow-md bg-white container-md min-w-full'>
      Card goes here
    </div>
  )
}
      ...
      <g id="XMLID_22_" transform="matrix(1, 0, 0, 1, 0.236789, -3.136466)">
        <g style={{}}>
          <g
            ...
            transform="matrix(0.707107, 0.707107, -0.707107, 0.707107, 0, -9e-06)"
          >
            <g style={{}}>
              <path
                style={{
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className='flex flex-1 flex-col'>
        ...
        <div className='flex-initial'>
          <GavelSealed height={500} width={500} />
        </div>
      </div>
    </main>
  )
